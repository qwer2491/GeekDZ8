...
import com.example.RSSReader.VKSource.MainActivity;
...
public class NewActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //SocialBufferVkontakte
        SharedPreferences vK = getSharedPreferences("SocialDataVk", MODE_WORLD_WRITEABLE);
        vK.edit().putString("SendNewsToVkontakte", info[0]).commit();
        //--END

        //SocialBufferFacebook
        SharedPreferences fB = getSharedPreferences("SocialDataFb", MODE_WORLD_WRITEABLE);
        fB.edit().putString("SendNewsToFacebook", info[0]).commit();
        //--END
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.itemShareOnFacebook:
                startActivity(new Intent(this,ConnectToFacebook.class));
            case R.id.itemShareOnVK:
